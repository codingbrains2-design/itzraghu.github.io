...
function pic1()
{
	...
	else 
	{
		...
		$stmt = $db->prepare("UPDATE ac SET image_path=?,heading=?,description=?,mrp=?,snp=? WHERE name=?");
...
function pic10()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic10']['name'];
...
function pic11()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic11']['name'];
...
function pic12()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic12']['name'];
...
}function pic13()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic13']['name'];
...
function pic14()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic14']['name'];
...
function pic15()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic15']['name'];
...
}function pic16()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic16']['name'];
...
function pic17()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic17']['name'];
...
function pic18()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic18']['name'];
...
function pic19()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic19']['name'];
...
function pic20()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../ac/' . "$date" . $_FILES['pic20']['name'];
