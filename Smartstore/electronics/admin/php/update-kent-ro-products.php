...
function pic1()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic1']['name'];
	...
	else 
	{
		...
		$stmt = $db->prepare("UPDATE kent SET image_path=?,heading=?,description=?,mrp=?,snp=? WHERE name=?");
...
function pic2()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic2']['name'];
...
function pic3()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic3']['name'];
...
function pic4()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic4']['name'];
...
function pic5()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic5']['name'];
...
function pic6()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic6']['name'];
...
function pic7()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic7']['name'];
...
function pic8()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic8']['name'];
...
function pic9()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic9']['name'];
...
function pic10()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic10']['name'];
...
function pic11()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic11']['name'];
...
function pic12()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic12']['name'];
...
}function pic13()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic13']['name'];
...
function pic14()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic14']['name'];
...
function pic15()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic15']['name'];
...
}function pic16()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic16']['name'];
...
function pic17()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic17']['name'];
...
function pic18()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic18']['name'];
...
function pic19()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic19']['name'];
...
function pic20()
{
	...
	$date = new DateTime();
	$date = $date->format("U");
	$path = '../../kent-ro/' . "$date" . $_FILES['pic20']['name'];
