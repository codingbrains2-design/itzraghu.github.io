...
$stmt = $db->query("SELECT * FROM refrigerators");
...
<div class="main">
  ...
  <div class="row">
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['0']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['0']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['1']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['1']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['2']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['2']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['3']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['3']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['4']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['4']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['5']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['5']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['6']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['6']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['7']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['7']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['8']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['8']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['9']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['9']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['10']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['10']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['11']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['11']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['12']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['12']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['13']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['13']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['14']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['14']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['15']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['15']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['16']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['16']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['17']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['17']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['18']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['18']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
    <div class="col-md-3">
      <a href="refrigerator-preview.php?img=<?php echo $row['19']['image_path'] ;?>" class="thumbnail">
      ...
      <span class="caption text-center">
        ...
        <a href="refrigerator-preview.php?img=<?php echo $row['19']['image_path'] ;?>" class="btn btn-primary center-block">Details</a>
      </span>
    </div>
  </div>
