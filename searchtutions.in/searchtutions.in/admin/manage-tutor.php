...
<head>
  ...
  <script type="text/javascript" src="../js/modernizr.custom.32033.js"></script>
    ...
    <body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
              ...
              <li>
                <a class="active-menu" href="manage-tutor.php"><i class="fa fa-users fa-3x"></i> Manage Tutors</a>
              </li>
              <li>
                  ...
                  <a href="manage-paid-tutor.php">
                    <div class="thumbnail">
                      <div class="caption text-center">
                        ...
                        <h4>Manage Paid Tutors</h4>
                      </div>
                    </div>
                  </a>
                </div>
                <div class="col-md-6">
                  <a href="manage-free-tutor.php">
                    <div class="thumbnail">                
                      <div class="caption text-center">
                        <span class="fa-stack fa-5x">
                          <i class="fa fa-square-o fa-stack-2x"></i>
     ...
     <script src="js/manage-tutor.js"></script>
