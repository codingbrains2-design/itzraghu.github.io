			...
			$.each(result, function(key, value){
				$.each(value, function(k, v){
					...
					if (k === 'image_path') {
						...
						$('#super_premium .spTutor').append(div);
						$('#super_premium .spTutor >.images:last').on('click', '#imgBtn', function(){
