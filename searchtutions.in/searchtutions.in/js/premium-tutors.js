			...
			$.each(result, function(key, value){
				$.each(value, function(k, v){
					...
					if (k === 'image_path') {
						...
						$('#premium .premiumTutor').append(div);
						$('#premium .premiumTutor >.images:last').on('click', '#imgBtn', function(){
