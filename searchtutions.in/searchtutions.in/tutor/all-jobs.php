...
<head>
  ...
  <script type="text/javascript" src="../js/modernizr.custom.32033.js"></script>
    ...
    <body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
              ...
              <li>
                <a  href="home.php"><i class="fa fa-user fa-3x"></i> Profile</a>
              </li>
              <li>
                <a  href="my-password.php"><i class="fa fa-key fa-3x"></i> Change Password</a>
              </li>
              <li>
                <a class="active-menu" href="all-jobs.php"><i class="fa fa-black-tie fa-3x"></i> View all Jobs</a>
              </li>
              <li>
                <a  href="my-jobs.php"><i class="fa fa-black-tie fa-3x"></i> Saved Jobs</a>
              </li>
            </ul>
          </div>
        </nav>  
     ...
     <script src="js/view-all-jobs.js"></script>
