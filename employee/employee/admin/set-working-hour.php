...
<head>
  ...
  <!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
    ...
    <body>
                ...
                <div class="example">
                  <div class="panel panel-danger">
                    <div class="panel-heading">
                      <h3 class="panel-title">Set Working Hour</h3>
                    </div>
                    <div class="panel-body">
                      <form id="workingHourForm" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                          <div class="col-sm-3">
                            <label for="workingHour">No. of hours</label>
                          </div>
                          <div class="col-sm-8">
                            <input type="text" id="workingHour" name="workingHour" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-sm-3">
                          ...
                          <div class="col-sm-8">
                            <button type="button" id="setWorkingHourBtn" class="btn btn-default">Submit</button>
                          </div>
                        </div>
                      </form>
                    </div>
      ...
      <script src="js/set-working-hour.js"></script>
